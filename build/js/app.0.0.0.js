...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.server = new _server2.default(props.buildprops.server_url);
	    _this.state = { booted: false, booterr: false, bootmsg: "not booted" };
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.server.reportClient().then(function (s) {
	        _this2.setState({ booted: true });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.booted) return _react2.default.createElement(
	        'div',
	        { className: '' },
	        'Connected received ',
	        this.state.rev
	      );else if (this.state.booterr) return _react2.default.createElement(
	        'div',
	        null,
	        'Looks like your user is not correctly configured, please email the system ower with this message ',
	        this.state.bootmsg
	      );else return _react2.default.createElement(
	        'div',
	        { className: '' },
	        'connecting...... ',
	        'to ' + JSON.stringify(this.props.buildprops)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_app2.default, { buildprops: buildprops }), document.getElementById('app'));
	//import 'babel-core/polyfill';

	//import './styles/main.scss';

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/mnt/c/Users/Keith/wsl_home/azappgate/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app_index.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Server = function () {
	  ...
	  _createClass(Server, [{
	    key: "_callServer",
	    value: function _callServer(path) {
	      var _this = this;

	      var mode = arguments.length <= 1 || arguments[1] === undefined ? 'GET' : arguments[1];
	      var body = arguments[2];

	      return new Promise(function (resolve, reject) {
	        // Instantiates the XMLHttpRequest
	        var client = new XMLHttpRequest();
	        client.open(mode, _this._host + path);
	        client.setRequestHeader("Authorization", "OAuth " + "Junk");
	        client.withCredentials = true;
	        if (mode === 'POST') {
	          console.log('_callServer: POSTING to [' + _this._host + path + ']: ' + JSON.stringify(body));
	    ...
	    key: "reportClient",
	    value: function reportClient() {
	      var _this2 = this;

	      return new Promise(function (resolve, reject) {
	        var timestamp = new Date().getTime();
	        _this2._callServer('/ping?time=' + timestamp).then(function (res1) {
	          var pingt = new Date().getTime() - res1.pings.time;
	          _this2._callServer('/reportPing?time=' + ptime).then(function (res2) {
	            resolve(res2);
	          });
	        });
	      });
	    ...
	    value: function logOut() {
	      ...
	      return this._callServer(this.ROUTES.auth + 'logout').then(function (succ) {
	        _this3.clearApp();
	        _this3._session = {};
	      });
	    }
	    ...
	    key: "loadApp",
	    value: function loadApp(appid) {
	      var _this4 = this;

	      return this._callServer(this.ROUTES.dform + 'loadApp/' + (appid && "?appid=" + appid || '')).then(function (val) {
	        _this4._appMeta = val.appMeta || [];
	        _this4._session = val.session;
	        _this4._currentApp = val.app;
	      });
	    }
	  }, {
	    key: "host",
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/mnt/c/Users/Keith/wsl_home/azappgate/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "server.es6" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
